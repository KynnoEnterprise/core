...
preparing test network with chain-id "kynno_97004-1"
...
```bash
kynnod keys add test --recover
```

Check the balance of the account address:

```bash
kynnod q bank balances [address]
```
