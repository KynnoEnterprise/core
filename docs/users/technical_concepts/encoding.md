...
Learn about the encoding formats used on Kynno. {synopsis}
...
previous versions, specially for client encoding and signing with Ledger devices. Kynno does not
...
allows for quick reconstruction of encoded data. Kynno uses RLP to encode/decode Ethereum
