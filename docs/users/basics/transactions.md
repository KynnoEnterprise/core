...
Learn more about transactions on Kynno {synopsis}
...
<!-- 
TODO: explain what transactions are on Kynno and blockchains. 
...
<!-- TODO: explain which transactions types does Kynno support (i.e modules and changes) and provide a few examples. -->
...
Kynno supports the following Ethereum transactions.
