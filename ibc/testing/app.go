...
import (
	...
	kynnoapp "github.com/kynnoenterprise/core/app"
)

var DefaultTestingAppInit func() (ibcgotesting.TestingApp, map[string]json.RawMessage) = kynnoapp.SetupTestingApp
...
func SetupWithGenesisValSet(t *testing.T, valSet *tmtypes.ValidatorSet, genAccs []authtypes.GenesisAccount, chainID string, balances ...banktypes.Balance) ibcgotesting.TestingApp {
	...
	app.InitChain(
		abci.RequestInitChain{
			...
			ConsensusParams: kynnoapp.DefaultConsensusParams,
