...
import (
	...
	cmdcfg "github.com/kynnoenterprise/core/cmd/config"
	kynnokr "github.com/kynnoenterprise/core/crypto/keyring"
)
...
// NewRootCmd creates a new root command for kynnod. It is called once in the
// main function.
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	...
	initClientCtx := client.Context{}.
		...
		WithKeyringOptions(kynnokr.Option()).
		WithViper(EnvPrefix)
...
func (a appCreator) appExport(
	...
	if height != -1 {
		kynnoApp = app.NewKynno(logger, db, traceStore, false, map[int64]bool{}, "", uint(1), a.encCfg, appOpts)

		if err := kynnoApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		kynnoApp = app.NewKynno(logger, db, traceStore, true, map[int64]bool{}, "", uint(1), a.encCfg, appOpts)
	}

	return kynnoApp.ExportAppStateAndValidators(forZeroHeight, jailAllowedAddrs)
}
