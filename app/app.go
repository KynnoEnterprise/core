...
import (
	...
	_ "github.com/kynnoenterprise/core/client/docs/statik"

	"github.com/kynnoenterprise/core/app/ante"
	"github.com/kynnoenterprise/core/x/claims"
	claimskeeper "github.com/kynnoenterprise/core/x/claims/keeper"
	claimstypes "github.com/kynnoenterprise/core/x/claims/types"
	"github.com/kynnoenterprise/core/x/epochs"
	epochskeeper "github.com/kynnoenterprise/core/x/epochs/keeper"
	epochstypes "github.com/kynnoenterprise/core/x/epochs/types"
	"github.com/kynnoenterprise/core/x/erc20"
	erc20client "github.com/kynnoenterprise/core/x/erc20/client"
	erc20keeper "github.com/kynnoenterprise/core/x/erc20/keeper"
	erc20types "github.com/kynnoenterprise/core/x/erc20/types"
	"github.com/kynnoenterprise/core/x/incentives"
	incentivesclient "github.com/kynnoenterprise/core/x/incentives/client"
	incentiveskeeper "github.com/kynnoenterprise/core/x/incentives/keeper"
	incentivestypes "github.com/kynnoenterprise/core/x/incentives/types"
	"github.com/kynnoenterprise/core/x/inflation"
	inflationkeeper "github.com/kynnoenterprise/core/x/inflation/keeper"
	inflationtypes "github.com/kynnoenterprise/core/x/inflation/types"
	"github.com/kynnoenterprise/core/x/recovery"
	recoverykeeper "github.com/kynnoenterprise/core/x/recovery/keeper"
	recoverytypes "github.com/kynnoenterprise/core/x/recovery/types"
	"github.com/kynnoenterprise/core/x/rewardshare"
	rewardsharekeeper "github.com/kynnoenterprise/core/x/rewardshare/keeper"
	rewardsharetypes "github.com/kynnoenterprise/core/x/rewardshare/types"
	"github.com/kynnoenterprise/core/x/vesting"
	vestingkeeper "github.com/kynnoenterprise/core/x/vesting/keeper"
	vestingtypes "github.com/kynnoenterprise/core/x/vesting/types"
	"github.com/kynnoenterprise/core/x/nft"
	nftKeeper "github.com/kynnoenterprise/core/x/nft/keeper"
	nfttypes "github.com/kynnoenterprise/core/x/nft/types"
)
var (
	// MainnetMinGasPrices defines 20B akynno as the minimum gas price value on the fee market module.
...
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, ".kynnod")

	// manually update the power reduction by replacing micro (u) -> atto (a) kynno
...
var (
	_ servertypes.Application = (*Kynno)(nil)
	_ simapp.App              = (*Kynno)(nil)
	_ ibctesting.TestingApp   = (*Kynno)(nil)
)

// Kynno implements an extended ABCI application. It is an application
...
type Kynno struct {
	*baseapp.BaseApp
	...
	RewardshareKeeper    rewardsharekeeper.Keeper
...
func NewKynno(
	...
	keys := sdk.NewKVStoreKeys(
		...
		rewardsharetypes.StoreKey,nfttypes.StoreKey,
	)
	...
	*/
	...
	// NOTE: Distr, Slashing must be created before calling the Hooks method to avoid returning a Keeper without its table generated
	...
	app.RewardshareKeeper = rewardsharekeeper.NewKeeper(
		keys[rewardsharetypes.StoreKey], appCodec, app.GetSubspace(rewardsharetypes.ModuleName),
	...
	// Set the ICS4 wrappers for recovery middlewares
	...
	app.mm = module.NewManager(
		...
		rewardshare.NewAppModule(app.RewardshareKeeper, app.AccountKeeper),
	...
	// so that other modules that want to create capabilities afterwards in InitChain
	// can do so safely.
	app.mm.SetOrderInitGenesis(
		...
		ibchost.ModuleName,
		// Ethermint modules
		// evm module denomination is used by the rewardshare module, in AnteHandle
		evmtypes.ModuleName,
...
func (app *Kynno) Name() string { return app.BaseApp.Name() }
...
func (app *Kynno) GetKey(storeKey string) *storetypes.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Kynno) GetTKey(storeKey string) *storetypes.TransientStoreKey {
...
func (app *Kynno) GetMemKey(storeKey string) *storetypes.MemoryStoreKey {
...
func (app *Kynno) GetStakingKeeper() ibctestingtypes.StakingKeeper {
	return app.StakingKeeper
}

// GetStakingKeeper implements the TestingApp interface.
func (app *Kynno) GetStakingKeeperSDK() stakingkeeper.Keeper {
	return app.StakingKeeper
}
...
func initParamsKeeper(
	...
	paramsKeeper.Subspace(rewardsharetypes.ModuleName)
	paramsKeeper.Subspace(nfttypes.ModuleName)
	return paramsKeeper
}

func (app *Kynno) setupUpgradeHandlers() {
	// v2 upgrade handler
