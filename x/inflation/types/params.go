...
func DefaultParams() Params {
	return Params{
		...
		ExponentialCalculation: ExponentialCalculation{
			A:             sdk.NewDec(int64(100_000_000)),
			R:             sdk.NewDecWithPrec(50, 2), // 50%
			C:             sdk.NewDec(int64(9_000_000)),
			BondingTarget: sdk.NewDecWithPrec(66, 2), // 66%
			MaxVariance:   sdk.ZeroDec(),             // 0%
		},
		InflationDistribution: InflationDistribution{
			StakingRewards:  sdk.NewDecWithPrec(533333334, 9), // 0.53 
			UsageIncentives: sdk.NewDecWithPrec(333333333, 9), // 0.33
			CommunityPool:   sdk.NewDecWithPrec(133333333, 9), // 0.13 
		},
