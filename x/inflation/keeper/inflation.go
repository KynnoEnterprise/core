...
import (
	...
	"github.com/kynnoenterprise/core/x/inflation/types"
)

// 120M token at year 4 allocated to the team
var teamAlloc = sdk.NewInt(120_000_000).Mul(ethermint.PowerReduction)
...
func (k Keeper) BondedRatio(ctx sdk.Context) sdk.Dec {
	...
	isMainnet := kynno.IsMainnet(ctx.ChainID())
...
func (k Keeper) GetCirculatingSupply(ctx sdk.Context) sdk.Dec {
	...
	if kynno.IsMainnet(ctx.ChainID()) {
