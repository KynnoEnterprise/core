...
// NewTxCmd returns a root CLI command handler for certain modules/rewardshare
// transaction commands.
func NewTxCmd() *cobra.Command {
	txCmd := &cobra.Command{
		Use:                        types.ModuleName,
		Short:                      "rewardshare subcommands",
	...
	txCmd.AddCommand(
		NewRegisterRewardshare(),
		NewCancelRewardshare(),
		NewUpdateRewardshare(),
	)
	return txCmd
}

// NewRegisterRewardshare returns a CLI command handler for registering a
...
// NewCancelRewardshare returns a CLI command handler for canceling a
// contract for fee distribution
...
// NewUpdateRewardshare returns a CLI command handler for updating the withdraw
