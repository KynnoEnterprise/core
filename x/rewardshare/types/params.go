...
func NewParams(
	...
	return Params{
		EnableRewardshare:            enableRewardshare,
...
func DefaultParams() Params {
	return Params{
		EnableRewardshare:            DefaultEnableRewardshare,
...
func (p *Params) ParamSetPairs() paramtypes.ParamSetPairs {
	return paramtypes.ParamSetPairs{
		paramtypes.NewParamSetPair(ParamStoreKeyEnableRewardshare, &p.EnableRewardshare, validateBool),
...
func (p Params) Validate() error {
	if err := validateBool(p.EnableRewardshare); err != nil {
		return err
	}
