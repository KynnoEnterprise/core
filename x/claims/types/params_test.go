...
func TestParamsValidate(t *testing.T) {
	testCases := []struct {
		...
		{
			"success - constructor",
			NewParams(true, "akynno", time.Unix(0, 0), DefaultDurationOfDecay, DefaultDurationUntilDecay, DefaultAuthorizedChannels, DefaultEVMChannels),
			false,
		},
	}
