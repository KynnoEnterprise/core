...
// source: core/claims/v1/claims.proto
...
func init() {
	proto.RegisterEnum("kynno.claims.migration.v1.Action", Action_name, Action_value)
	proto.RegisterType((*Claim)(nil), "kynno.claims.migration.v1.Claim")
	proto.RegisterType((*ClaimsRecordAddress)(nil), "kynno.claims.migration.v1.ClaimsRecordAddress")
	proto.RegisterType((*ClaimsRecord)(nil), "kynno.claims.migration.v1.ClaimsRecord")
}

func init() { proto.RegisterFile("kynno/claims/v1/claims.proto", fileDescriptor_a7153f2307523893) }
