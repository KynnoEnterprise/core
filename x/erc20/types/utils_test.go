	...
	testCases := []struct {
	...
	}{
		{
			...
			banktypes.Metadata{
				...
				Name:        "Kynno",
				Symbol:      "KYNNO",
				Description: "EVM, staking and governance denom of Kynno",
				DenomUnits: []*banktypes.DenomUnit{
					{
						Denom:    "akynno",
						Exponent: 0,
						Aliases:  []string{"atto kynno"},
					},
					{
						Denom:    "kynno",
						Exponent: 18,
				...
				DenomUnits: []*banktypes.DenomUnit{
					{
						Denom:    "akynno",
						Exponent: 0,
						Aliases:  []string{"atto evkynnomos"},
					},
				},
			},
			true,
...
func TestEqualAliases(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			[]string{"atto kynno", "akynno"},
			[]string{"akynno", "atto kynno"},
			false,
		},
		{
			"same values, sorted",
